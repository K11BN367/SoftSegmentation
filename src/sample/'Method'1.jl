...
function sample(Hyperparameter_Array_Length::Integer, Lower_Bound::T1, Upper_Bound::T1, Sample_Algorithm::ShuffleSampleAlgorithm{Vector{T3}, N}) where {T1<:Union{Number, Union{Tuple{Vararg{T2}}, AbstractVector{<:T2}}}} where {T2, T3, N}
